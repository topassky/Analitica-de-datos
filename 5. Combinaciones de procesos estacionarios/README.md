...
<p align="justify">  Una consecuencia de este resultado es que las autocovarianzas deben cumplir ciertas condiciones para corresponder a un proceso estacionario. Si se define la combinación lineal de los valores retardados del proceso escalar <img src="https://latex.codecogs.com/svg.image?\z_{t}"> mediante: </p>
