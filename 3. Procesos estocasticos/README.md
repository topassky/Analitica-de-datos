...
<p align="center"><img src="[https://latex.codecogs.com/svg.image?Var(z_{2})=E(z_{2}^{2})=2\sigma^{2}](https://latex.codecogs.com/svg.image?Var(z_{2})=E(z_{2}^{2})=E(z_{1}^{2}&plus;a_{2}^{2}&plus;2z_{1}a_{2})=2\sigma^{2})"></p>
